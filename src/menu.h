...
//    Etiqueta,    		Nivel,          tipo de item,   	Nivel_Next,     	Nivel_Back,    Tecla_Rapida,PreProceso,PostProceso,Variable, CantDigitos,
    ...
    {ET_CHOFER,    		ID_RECORRIDO_D, TIPO_TXT_SM_SL, 	ID_RECORRIDO_I, 	ID_PRINCIPAL,  TEC_VOID, PRE_VOID,POST_START_RECORRIDO,TXT_CHOFER,  16},
    
	{ET_1_RECEPCION, 	ID_RECORRIDO_I,	TIPO_ETIQ, 			ID_TAMBO,       	ID_VOID,        '1',	PRE_VOID,POST_VOID, VAR_VOID, 0},
    {ET_2_TRASVASE, 	ID_RECORRIDO_I,	TIPO_ETIQ, 			ID_TAMBO,       	ID_VOID,        '2',    PRE_VOID,POST_VOID, VAR_VOID, 0},
    {ET_4_FIN_RECORR, 	ID_RECORRIDO_I,	TIPO_ETIQ, 			ID_PRINCIPAL,       	ID_VOID,        '4',    PRE_VOID,POST_VOID, VAR_VOID, 0},
    {ET_5_TRASBORDO, 	ID_RECORRIDO_I,	TIPO_ETIQ, 			ID_TAMBO,       	ID_VOID,        '5',    PRE_VOID,POST_VOID, VAR_VOID, 0},
	...
	{ET_TAMBERO,		ID_TAMBO,			TIPO_TXT_SM_SL	,			ID_LITROS_CARGAR,	ID_RECORRIDO_I,	TEC_VOID, PRE_VOID,POST_VOID,TXT_TAMBERO,	12},
